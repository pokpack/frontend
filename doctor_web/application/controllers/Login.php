...
class Login extends CI_Controller
{
    ...
    public function check_login()
    {
        ...
        if ($num_row > 0) {
            ...
            //            $this->session->set_userdata(array('doctor_user_id' => $data->id, 'username' => $data->s_username, 'firstname' => $data->s_first_name , 'lastname' => $data->s_last_name, 'type_user' => $data->i_type));
    ...
    {
        $array_items = array('doctor_user_id', 'username', 'name');
