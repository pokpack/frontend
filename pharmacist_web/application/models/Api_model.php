...
class Api_model extends CI_Model
{
    ...
    public function get_exn()
    {
        ...
        $curl = curl_init();
        $url = (getenv('EMR_API_URL') || "localhost:3001") . "/api/examinations";
    ...
    public function get_emr_id($hn, $emr)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_PORT => "3001",
            CURLOPT_URL => (getenv('EMR_API_URL') || "localhost:3001") . "/api/" . $hn . "/emr/" . $emr,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
    ...
    public function post_dis()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_PORT => "3001",
            CURLOPT_URL => (getenv('EMR_API_URL') || "localhost:3001") . "/api/" . $hn . "/dispense/" . $emr,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
